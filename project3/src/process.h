...
#define TRUE 1
#define FALSE 0
#define STARTING_QUANTUM 6
#define QUANTUM_DEDUCTION 3
#define IO_PRIORITY_BOOST 2
#define STARVING_PRIORITY_LEVEL 15
#define PROCESS_STARVING 1
#define PROCESS_BOOSTED 2
#define STARVING_THRESHOLD 300
...
void scheduleProcessHelper(PCB *);
